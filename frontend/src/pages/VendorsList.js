          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: 'rgba(25,28,30,0.5)' }}>
            <div className="rounded-2xl p-6 w-full max-w-md" style={{ background: '#FFFFFF' }}>
              ...
              <div className="flex justify-end gap-2 mt-6">
                ...
                <button data-testid="save-vendor-btn" onClick={handleCreateVendor} className="px-4 py-2 rounded-lg text-sm font-medium text-white" style={{ background: 'linear-gradient(135deg, #0037B0, #1D4ED8)' }}>
                  Save Vendor
                </button>
              </div>
            </div>
